...
<body>
	...
	<table><tr>
    <td>
	<a title="Back to home" href=""  " ><img  style="float:left;"  src="LogocassifAi.png" alt="MultiChain logo" /></a> 
    </td>
    
    <td style="padding-left: 195px;" valign="middle">
 
	<h1 style="font-size:27px"  >%(h1)s</h1>
   
	</td>

    <td  style="padding-left: 230px;" >
         <a title="Back to home" href=""  " ><img  style="float:right; "  src="LogoMediatica2022.png" alt="MultiChain logo" /></a>
    </td>
...
#            print(refresh_script)
    ...
    def handle_chains(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="MultiChain Explorer Dashboard"
        tvars['h1']="MultiChain Explorer Dashboard"
...
#        body += '<div id="holders">' + DEFAULT_LOADING_HTML + '</div>'
        splitword = '-'
        tvars['body']=body          
        title=" - Asset: " + entity_name.partition(splitword)[0]
        tvars['title']="MultiChain Explorer - " + chain.config['display-name'] + title
        tvars['h1']='<a href="'+chain.config['path-name']+'">' + chain.config['display-name'] + '</a>' + title
...
# List of divs to be updated and elements of the path which should retreive data for this div
    ...
    def handle_notfound(self,chain=None,params=None,nparams=None):
        tvars=self.template_vars.copy();
        tvars['body']='<p class="error">Si Prega di effettuare nuovamente la login da ClassifAI </p>';
        
        title=" <h3 > Token Non Valido oppure scaduto </h3> "
        if chain is None:
